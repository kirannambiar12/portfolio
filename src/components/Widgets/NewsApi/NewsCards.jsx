...
const NewsCards = ({ article }) => {
    return (
        <div className="card news-card background-black">
            <div>
            <img className="img-fluid card-img-top" src={article?.urlToImage || "https://media.ticketmaster.co.uk/tm/en-gb/img/mw/images/f0/87/122346p1.jpg"} alt="article visual presentation" />
            </div>
